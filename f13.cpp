...
class TICKET
{
 public :
   ...
   char *FLIGHTNO(int) ;
 private :
   void ADD_RECORD1(char[26], char[36], char[36], int, int) ;
 protected :
...
class PASSANGER
{
 public :
   ...
   char *NAME(int) ;
 protected :
   char Class, name[26], address[36], gender ;
...
void TICKET :: ADD_RECORD1(char t_fltno[10], char t_from[15], char t_to[15], int t_ecofair, int t_exefair)
{
 fstream file ;
...
void TICKET :: ADDITION(void)
{
 ...
 if (!file.fail())
  return ;
 file.close() ;
 ADD_RECORD1("KL146","DELHI","MUMBAI",1500,1700) ;
 ADD_RECORD1("KL146","MUMBAI","DELHI",1500,1700) ;
 ADD_RECORD1("KL156","DELHI","CALCUTTA",1700,1900) ;
 ADD_RECORD1("KL156","CALCUTTA","DELHI",1700,1900) ;
 ADD_RECORD1("KL166","DELHI","MADRAS",2100,2300) ;
 ADD_RECORD1("KL166","MADRAS","DELHI",2100,2300) ;
 ADD_RECORD1("KL176","MUMBAI","CALCUTTA",1900,2100) ;
 ADD_RECORD1("KL176","CALCUTTA","MUMBAI",1900,2100) ;
 ADD_RECORD1("KL186","MUMBAI","MADRAS",1800,2000) ;
 ADD_RECORD1("KL186","MADRAS","MUMBAI",1800,2000) ;
 ADD_RECORD1("KL196","CALCUTTA","MADRAS",1600,1800) ;
 ADD_RECORD1("KL196","MADRAS","CALCUTTA",1600,1800) ;
}
void TICKET :: ENQUIRY(void)
{
 ...
 gotoxy(2,5) ;
 printf(" Sno. FLIGHT NO.    FROM          TO           ECONOMIC FAIR  EXECUTIVE FAIR") ;
 system("color 09");
 int row=7, sno=1 ;
 while (file.read((char *) this, sizeof(TICKET)))
 {
...
void RESERVE :: RESERVATION(void)
{
 system("cls");
 ENQUIRY() ;
 char t1[5], pclass, pname[26], paddress[36], pgender, pfltno[10] ;
 ...
 {
  gotoxy(5,25) ; 
  cout<<"ENTER gender OF THE PASSANGER" ;
  gotoxy(15,7) ;
  pgender = getche() ;
  pgender = toupper(pgender) ;
  if (pgender == '0')
   return ;
 } while (pgender != 'M' && pgender != 'F') ;
 do
 {
  valid = 1 ;
  gotoxy(5,25) ;
 ...
 p.ADD_RECORD(tno,sno,pname,paddress,page,pgender,pclass) ;
 getch() ;
}
void PASSANGER :: ADD_RECORD(int tno, int sno, char pname[26], char paddress[36], int page, char pgender, char pclass)
{
 fstream file ;
 ...
 while (file.read((char *) this, sizeof(PASSANGER)))
 {
  if (sno == slno)
  {
   ...
   if ( row == 21 )
   {
    ...
    system("color 06") ;
    gotoxy(2,5) ;
    printf(" TICKET NO.    NAME                     FLIGHT NO.           CLASS            ") ;
    system("color 09") ;
   }
   else
    row++ ;
...
int main(void)
{
 ...
 system("color 09") ;
 cout<<"\n\n\t\t\a\a   WELCOME TO AIRLINE RESERVATION SYSTEM "<<endl ;
 ...
 while (1)
 {
  ...
  if (ch == '3')
  {
   while (1)
   {
    ...
    gotoxy(29,10) ;
    printf("EDIT PASSENGER RECORDS") ;
    gotoxy(29,11) ;
    printf("~~~~~~~~~~~~~~~~~~~~~~") ;
    gotoxy(33,12) ;
    printf("1: PASSANGER INFORMATION") ;
    gotoxy(33,13) ;
    printf("2: DELETE") ;
    gotoxy(33,14) ;
    printf("0: EXIT") ;
